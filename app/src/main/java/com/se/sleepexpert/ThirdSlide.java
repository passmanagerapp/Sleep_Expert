...
import com.se.sleepexpert.databinding.FragmentThirdSlideBinding;
...
public class ThirdSlide extends Fragment {
    private FragmentThirdSlideBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentThirdSlideBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        Call<List<String>> call = service.callSea;
